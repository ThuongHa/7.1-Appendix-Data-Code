...
# This script calculates the overlap between the combined callsets and truthset
# Usage example: ./intersect_sh > NA12878_intersect.txt

# Set variables #
calldir=/home/neuro/Documents/Thuong/2017/NA12878/callsets
truthdir=/home/neuro/Documents/Thuong/2017/NA12878/truthsets/bed
...
for i in ${calldir}/DEL/*all*key; do
	file=$(basename ${i} .key)
...
for i in ${calldir}/DUP/*all*key; do
	file=$(basename ${i} .key)
...
for i in ${calldir}/BND/*all*key ${calldir}/INS/*key; do
	file=$(basename ${i} .key)
...
for i in ${calldir}/INV/*all*key; do
	file=$(basename ${i} .key)
...
for i in ${calldir}/BND/*all*key ${calldir}/INS/*all*key; do
	file=$(basename ${i} .key)
